...
1. Start the program.
2. Declare a structure and a pointer to the structure.
3. Prompt and read structure values using pointer.
4. Access structure members using pointer (-> operator).
5. Print the structure values and stop the program.
...
## Output:
<img width="453" height="415" alt="image" src="https://github.com/user-attachments/assets/7dd3e666-5a77-4f84-8872-45682f19846b" />
